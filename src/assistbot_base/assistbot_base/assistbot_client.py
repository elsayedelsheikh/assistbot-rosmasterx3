...
class RobotComms(Node):
    def __init__(self):
        ...
        self.get_logger().info("Configuration Wheel_base:%0.2f"%(self.WHEEL_BASE))
        self.get_logger().info("Configuration Wheel_radius:%0.2f"%(self.WHEEL_RADIUS))
        self.get_logger().info("Configuration TicksPerRev:%0.2f"%(self.TPR))
    ...
    def control_cycle(self):
        ...
        while rclpy.ok():
            ...
            if self.data.success:
                ...
                if self.debug:
                    self.get_logger().info("Encoder Data FR,FL,BL,BR: %d, %d, %d, %d"%(f_r,f_l,b_l,b_r))
